---
title: BIN Lore
description: Comprehensive broadcast archive and lore network for Barely Informed News.
---

# BIN Lore

The comprehensive broadcast archive and newsroom record for **Barely Informed News** — the premier satirical broadcast network anchored by [[characters/case-blackwell|Case Blackwell]].

This archive documents the network's on-air correspondents, investigative programming, evolving newsroom storylines, and complete broadcast telecasts as they unfold live on air.

> **Fan Site Notice:** BIN Lore is an independent, non-commercial fan documentation project. It is not affiliated with, endorsed by, or sponsored by Case Blackwell, Barely Informed News, or Twitch. All trademarks, names, likenesses, and broadcast assets belong to their respective copyright holders and are referenced under fair use for commentary, criticism, and archival purposes. Not operated for profit. See the full [[disclaimer|Legal & Fan Disclaimer]].
...
Notice missing broadcast lore, an unrecorded correspondent appearance, or a detail requiring editorial correction? Network contributions are warmly welcomed! Please feel free to [submit a pull request on GitHub](https://github.com/trak3r/binlore) with your suggested updates or additions. Sourced notes with broadcast dates and timestamps are especially appreciated.

## Legal Disclaimer

This wiki is operated strictly as a non-commercial, non-profit community fan archive under the Fair Use doctrine (17 U.S.C. § 107). No copyright or trademark infringement is intended. All broadcast elements and trademarks remain the property of Case Blackwell / Barely Informed News. Read our complete [[disclaimer|Legal & Fan Disclaimer]] for non-affiliation, fair use, parody, and takedown policy details.
