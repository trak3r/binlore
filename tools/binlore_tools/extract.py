...
- Canonical Show Segments:
  ...
  5. "Chet Guy the Science Eyes": The parody science segment (spoofing Bill Nye), hosted by **Chet (Chet Manscape)**. Brings an optical microscope prop onto the desk, puts on a serious academic demeanor in a patterned purple blazer, and analyzes bizarre medical studies (e.g. plastic surgery ratios). Note: Whisper ASR often transcribes "Chet" / "Science Eyes" phonetically as "Skynce" or "Chad". Reconcile to Chet!
...
- Note on ASR transcription: The input transcript was generated by automated speech recognition (Whisper). Names may have phonetic variations (e.g. "Crumb" for "Crum", "Monch" for "Munch", "Skynce" / "Chad" for "Chet", "Jeff Hooper" for "Jeff Ripple"). Reconcile them to known canon entities when possible.
