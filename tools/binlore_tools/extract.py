...
- Note on Politicians & Real-World Public Figures: When real-world politicians or public figures (e.g. Mitch McConnell, Donald Trump, JD Vance, Lindsey Graham) appear as topics in the news or are parodied/imitated, accurately identify them as public figures being reported on, debated, or parodied—never describe them as network employees, on-air personalities, or newsroom staff.
...
1. "segments": Major show segments with start and end timestamps (e.g. "MM:SS" or "HH:MM:SS"), matching to canonical show segments ("News", "Hype Train", "Munch & Crum", "Chet Guy the Science Eyes", "Cryptozeus", "Amongst the Web", "Trip on the Street", "AI Rooney", "Pre-show / Cold Open"), a descriptive title for this episode's topic, and concise notes.
